...
public class PortRenderItemInFrameEvent extends PortEvent {
    private final RenderItemInFrameEvent e;
    ...
    static {
        PortEventHooks.register(RenderItemInFrameEvent.class, PortRenderItemInFrameEvent.class, PortRenderItemInFrameEvent::new);
    }
}
