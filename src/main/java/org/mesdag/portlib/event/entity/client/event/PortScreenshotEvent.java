...
public class PortScreenshotEvent extends PortEvent {
    private final ScreenshotEvent e;
    ...
    static {
        PortEventHooks.register(ScreenshotEvent.class, PortScreenshotEvent.class, PortScreenshotEvent::new);
    }
}