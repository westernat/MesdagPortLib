...
public interface PortAttachmentHolder extends IPortAttachmentHolder {
    ...
    static PortAttachmentHolder of(BlockEntity o) {
        return (PortAttachmentHolder) o;
    }

    static PortAttachmentHolder of(Entity o) {
        return (PortAttachmentHolder) o;
    }

    static PortAttachmentHolder of(Level o) {
        return (PortAttachmentHolder) o;
    }

    static PortAttachmentHolder of(ChunkAccess o) {
        return (PortAttachmentHolder) o;
    }
