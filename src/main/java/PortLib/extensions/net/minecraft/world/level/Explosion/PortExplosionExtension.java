package PortLib.extensions.net.minecraft.world.level.Explosion;
...
public class PortExplosionExtension {
    public static DamageSource getDefaultDamageSource(Level level, Entity source) {
