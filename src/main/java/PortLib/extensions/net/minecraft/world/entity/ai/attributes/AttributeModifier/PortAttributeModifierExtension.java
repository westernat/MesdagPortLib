...
public class PortAttributeModifierExtension {
    private static final MapCodec<AttributeModifier> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            PortAttributeModifierExtension.Operation.codec().fieldOf("operation").forGetter(AttributeModifier::getOperation)
    ...
    public static PortAttributeModifier wrap(AttributeModifier thiz) {
        return new PortAttributeModifier(PortAttributeModifier.uuid2rl(thiz.getId()), thiz.getAmount(), PortAttributeModifierExtension.Operation.wrap(thiz.getOperation()));
    }

    public static class Operation {
        private static final Codec<AttributeModifier.Operation> CODEC = PortAttributeModifier.Operation.CODEC.xmap(PortAttributeModifier.Operation::unwrap, PortAttributeModifierExtension.Operation::wrap);
        private static final PortStreamCodec<ByteBuf, AttributeModifier.Operation> STREAM_CODEC = PortAttributeModifier.Operation.STREAM_CODEC.map(PortAttributeModifier.Operation::unwrap, PortAttributeModifierExtension.Operation::wrap);
        ...
        public static PortAttributeModifier.Operation wrap(AttributeModifier.Operation thiz) {
